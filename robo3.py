...
rospy.init_node('robo2')
sub = rospy.Subscriber('/robot_2/odom',Odometry, get_pos)
pub = rospy.Publisher('/robot_2/cmd_vel', Twist, queue_size = 10)
posi  = Odometry()	
rate = rospy.Rate(10)
...
while not rospy.is_shutdown():
	while True:
		...
		while True:
			...
			msgScan = rospy.wait_for_message('/robot_2/base_scan', LaserScan)
